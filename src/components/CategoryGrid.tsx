      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 md:gap-4">
        {categories.map((cat, i) => (
          <motion.button
            ...
            whileHover={{ y: -5 }}
            className="group flex flex-col items-center gap-3 bg-white rounded-2xl p-4 md:p-5 border border-black/[0.04] shadow-[0_1px_3px_rgba(18,32,63,0.06)] hover:shadow-[0_12px_24px_rgba(18,32,63,0.1)] transition-shadow"
          >
            <div
